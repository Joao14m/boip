...
# Firebase Storage bucket — same value as the frontend's FIREBASE_STORAGE_BUCKET.
# Required so the backend can clean up uploaded media when a listing is deleted.
